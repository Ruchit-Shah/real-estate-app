...
class My_Property_Virtual_Schedules extends StatefulWidget {
  const My_Property_Virtual_Schedules({super.key});

  @override
  State<My_Property_Virtual_Schedules> createState() => _My_Property_Virtual_SchedulesState();
}

class _My_Property_Virtual_SchedulesState extends State<My_Property_Virtual_Schedules> {
  ...
  getUserID() async{
    ...
    user_id=userId!;
    if(userId!=null){
      // profileController.get_tour_List(userId);
    }
  }
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      '${tour['property_owner_details']['full_name']}',
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    Row(
                      children: [
                        ...
                        tour['status'] != "Cancelled" || tour['status'] != "Attended"?
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            showCallLeaveDialog(
                                ...
                                'Yes',
                                'No ', () {
                              profileController.update_tour_Status(tour_id: tour['_id'],Status:'Cancelled',from: 'enquiry');
