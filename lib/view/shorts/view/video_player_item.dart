...
class _VideoPlayerItemState extends State<VideoPlayerItem> {
    ...
    return VisibilityDetector(
      ...
      onVisibilityChanged: (visibilityInfo) async {
        if (visibilityInfo.visibleFraction > 0.0) {
          print("home page video  visible ===> true");

          if (homeController.homeVideosDataList.isNotEmpty) {
            // await controller.myVideosDataList[controller.currentPage.value]["controller"]!.play();
            homeController.homeVideosDataList[homeController.currentPage.value]["controller"]!.play();
            widget.controller.play();
          }
        } else {
          print("home page video invisible ");

          if (homeController.homeVideosDataList.isNotEmpty) {
            // await controller.myVideosDataList[controller.currentPage.value]["controller"]!.pause();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        //             userData: widget.videoData['user_data']));
                        //       }
                        //     }),
                        //     //widget.videoData
                        ...
                        GestureDetector(
                          onTap: () => applyLoginCheck(() {
                            print('widget.list[widget.indexVideo]["user_data"]["mobile_number"]-->');
                            print(widget.list[widget.indexVideo]["user_data"]["mobile_number"]);
                            _makePhoneCall(widget.list[widget.indexVideo]["user_data"]["mobile_number"].toString());
                          }),
                        ...
                        //         // videoUrl: "${APIShortsString.videoBaseUrl}${homeController.homeVideosDataList[homeController.currentPage.value]["video"]["video"]}",
                        //         // fileName: homeController.homeVideosDataList[homeController.currentPage.value]["video"]["video"],
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  onTap: () => applyLoginCheck(() {
                                    ...
                                    print('User Contact: ');
                                    if (kDebugMode) {
                                      print('User Contact: ${data["user_contact"]}');
                                    }
                                    //if (kDebugMode) {
                                      print("widget.videoData[video][_id]  ${widget.videoData["video"]} User Contact: ${data["user_contact"]}");
                                    //}
                                    Get.dialog(
                                      LookBookUi(selectedProduct: index,userId: widget.videoData["video"]["user_id"],
                                          videoId: widget.videoData["video"]["_id"],productId: data["_id"]),
  ...
  Future<void> _makePhoneCall(String mobileNumber ) async {
    ...
    print('_makePhoneCall12334: $mobileNumber');
