...
import '../../../dashboard/bottom_navbar_screens/profile_screen/profile_section_screens/MyProjects/MyProjects.dart';
import '../../../subscription model/controller/SubscriptionController.dart';


class project_start_page extends StatefulWidget {
  final String? isFrom;
  const project_start_page({super.key,this.isFrom});

  @override
  _project_start_pageState createState() => _project_start_pageState();
}


class _project_start_pageState extends State<project_start_page> {
  ...
  setNextButton(){
    setState(() {
      ...
      if (widget.isFrom == 'myprojects'){
        ...
        controller.selectedIndex.value = (controller.selectedIndex.value == 0) ? 0 : 1;
      }
  ...
  void ClearFiled() {
    ...
    controller.countryName.value = '';
    controller.reraIDController.clear();
    controller.countryController.clear();
  ...
  bool validationProjectAndArea() {
    ...
    if (controller.priceDetailsList.isEmpty) {
      ...
      // If priceDetailsList is not empty, clear error flags
                      ...
                      children: [
                        ...
                        controller.currentViewIndex.value == controller.views.length - 1
                          ...
                          onTap: () {
                            ...
                            Get.offAll(() => const MyProjects(isFrom: 'post',));
                          },
                          child: Container(
                            width: 80,
                            height: 40,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          boxH05(),
          const Text(
            "You can add your property using Hozza AI ",
                            ...
                            if( paidFeaturedCount != 0){
                              ...
                              SubscriptionDialog.show(
                                ...
                                onPurchase: () {
                                  // Handle purchase flow
                                  Navigator.push(context, MaterialPageRoute(
                                      builder: (_) => const PlansAndSubscription(isfrom: 'all',)
                                  )).then((value) async {
                                    await checkPlan();
                                  });
                                },
...
class _ProjectPriceDetailsState extends State<projectPriceDetails> {
                ...
                children: [
                  ...
                  controller.priceDetailsList.isNotEmpty
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      controller.priceDetailsList.isEmpty|| controller.addMode.value?
                          const SizedBox():
                      SizedBox(
                        width: Get.width,
                        child: OutlinedButton(
                          ...
                          child: Text(
                            controller.priceDetailsList.isNotEmpty? 'Add More Project':'Add Project',
                            style: TextStyle(
                              color: Colors.purple.withOpacity(0.8),
                              fontSize: 16,
                              fontWeight: FontWeight.w600,
  ...
  void calculateAveragePrice() {
    ...
    List<int> prices = controller.priceDetailsList
        .map((e) => int.tryParse(e.price.replaceAll(',', '')) ?? 0)
        .where((price) => price > 0)
        .toList();
    ...
    if (prices.isEmpty) {
      ...
      // String formattedMin = formatShortIndianPrice(min);
      // String formattedMax = formatShortIndianPrice(max);

      String formattedMin = min.toString();
      String formattedMax = max.toString();
    ...
    final bhkTypes = controller.priceDetailsList
        .map((e) => e.bhkType.trim())
