...
class _PropertySearchLocationScreenState extends State<PropertySearchLocationScreen> {
  ...
  //
  //   pController.citiesMap.value = await getAreasOrCitiesFromPolygon(_userPolyLinesLatLngList);
        ...
        controller.showresult.value && controller.getSearchList.isNotEmpty && isAPIcall
          ...
          onTap: () {
            ...
            Get.to(() => ExpandableResultScreen(
                ...
                search_keyword: "",
                property_category_type:   propert_type,
                category_price_type: widget.data == "Commercial" || widget.data == "Residential" || widget.data == "PG"
                    ? ""
                    : widget.data,
                property_type: widget.data == "PG" ? widget.data : "",
                bhk_type: controller.selectedBHKTypeList.join(","),
  ...
  void _onPanEnd(DragEndDetails details) async {
    ...
    if (_drawPolygonEnabled) {
      ...
      final polygonPoints = _userPolyLinesLatLngList
  ...
  // Future<String> getCitiesFromPolygon(List<LatLng> polygon) async {
  //   Set<String> cities = {};
  //
  ...
  //
  //   // Sample points in a grid inside bounding box
  //   int steps = 5; // increase for more accuracy
  ...
  //             print("Cities under polygon: $cities");
  //           }
  //         } catch (e) {
...
// Future<String> getAreasAndCitiesFromPolygon(List<LatLng> polygon) async {
//   Set<String> areasAndCities = {};
//
//   if (polygon.isEmpty) return '';
//
//   final poly = polygon.map((p) => mp.LatLng(p.latitude, p.longitude)).toList();
...
//               areasAndCities.add('$area, $city'); // e.g., "Baner, Pune"
//             } else if (city.isNotEmpty) {
//               areasAndCities.add(city);
//             }
//           }
//         } catch (e) {
//           print("Geocoding error: $e");
