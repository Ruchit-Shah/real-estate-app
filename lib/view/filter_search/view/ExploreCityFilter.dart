...
class ExploreCityFilter extends StatefulWidget {
  ...
  @override
  State<ExploreCityFilter> createState() => _ExploreCityFilterState();
}

class _ExploreCityFilterState extends State<ExploreCityFilter> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Get.to( FilterSearchScreen(
                    searchQuery: searchControllerField.text != '' ?
                    searchControllerField.text : widget.searchKeyword ?? '',
                      ...
                      children: <Widget>[
                        SizedBox(
                          ...
                          child: GoogleMap(
                            ...
                            markers: filterController.markers,
                          ),
                        ),
