...
class ExploreServiceFilterList extends StatefulWidget {
  ...
  @override
  State<ExploreServiceFilterList> createState() => _ExploreServiceFilterListState();
}

class _ExploreServiceFilterListState extends State<ExploreServiceFilterList> {
  ...
  Future<void> loadMoreData() async {
    ...
    if (filterController.hasMore.value && !filterController.isPaginationLoading.value) {
      ...
      if (searchControllerField.text.isNotEmpty) {
        ...
        await filterController.getFilterCityCategoryProperty(
          ...
          property_type:  filterController.selectedPropertyType.isEmpty? filterController.initialPropertyType.value:filterController.selectedPropertyType.join(","),
          sort_by:  postController.sortBY.value,
          city_name: searchControllerField.text,
          page: nextPage,
  ...
  Future<void> initialFilterAPI() async {
    await  filterController.getFilterCityCategoryProperty(
        city_name: widget.searchKeyword,
        area: widget.area,
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Get.to( FilterSearchScreen(
                    searchQuery: searchControllerField.text != '' ? searchControllerField.text : widget.searchKeyword ?? '',
                    ...
                    Expanded(
                      child: Obx(() {
                        ...
                        return RefreshIndicator(
                            onRefresh: () async {
                              filterController.getFilterCityCategoryProperty(
                                  city_name: searchControllerField.text,
                                  property_type:filterController.initialPropertyType.value,
                                  page: '1'
                              );
                            },
