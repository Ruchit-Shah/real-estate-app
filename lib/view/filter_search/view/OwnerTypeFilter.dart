...
class OwnerTypeFilter extends StatefulWidget {
  ...
  @override
  State<OwnerTypeFilter> createState() => _OwnerTypeFilterState();
}

class _OwnerTypeFilterState extends State<OwnerTypeFilter> {
    ...
    if (filterController.hasMore.value && !filterController.isPaginationLoading.value) {
      ...
      if (searchControllerField.text.isNotEmpty) {
        ...
        await filterController.getFilterCityCategoryProperty(
          ...
          searchControllerField.text : filterController.initialCityName.value ?? '',
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Get.to( FilterSearchScreen(
                    searchQuery: searchControllerField.text != '' ? searchControllerField.text : widget.city_name ?? '',
                        ...
                        return RefreshIndicator(
                            onRefresh: () async {
                              filterController.getFilterCityCategoryProperty(
                                  ...
                                  property_listed_by: widget.property_listed_by,
                                  city_name: searchControllerField.text != '' ? searchControllerField.text : widget.city_name ?? '',
