...
import 'package:real_estate_app/view/look_book/view/look_book_view.dart';
import 'package:real_estate_app/view/shorts/view/required_login.dart';
...
import '../../shorts/controller/follow_controller.dart';
import '../../shorts/controller/home_controller.dart';
...
class TrendingVideoPlayerItem extends StatefulWidget {
  ...
  @override
  State<TrendingVideoPlayerItem> createState() => _TrendingVideoPlayerItemState();
}

class _TrendingVideoPlayerItemState extends State<TrendingVideoPlayerItem> {
    ...
    return VisibilityDetector(
      ...
      onVisibilityChanged: (visibilityInfo) async {
        if (visibilityInfo.visibleFraction > 0.0) {
          print("video player item page visible ");

          if (trendingVideoController.trendingVideosDataList.isNotEmpty) {
            trendingVideoController.trendingVideosDataList[trendingVideoController.currentPage.value]["controller"]!.play();
            widget.controller.play();
          }
        } else {
          print("video player item page invisible");
              ...
              children: [
                Align(
                  ...
                  child: isLogin == true
                      ...
                      : TextButton(
                          onPressed: () {
                            trendingVideoController.trendingVideosDataList[trendingVideoController.currentPage.value]["controller"]!.pause();
                    ...
                    child: Column(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => applyLoginCheck(() {
                            print("isLogin");
                            // const String shareText = 'Hey check out my app at: ';
                        ...
                        // GestureDetector(
                        //   onTap: (){
                        //     Get.dialog(FileDownload(
                        //         // videoUrl: "${APIShortsString.videoBaseUrl}${trendingVideoController.trendingVideosDataList[trendingVideoController.currentPage.value]["video"]["video"]}",
                        //         // fileName: trendingVideoController.trendingVideosDataList[trendingVideoController.currentPage.value]["video"]["video"],
                        //          videoUrl: "${APIShortsString.videoBaseUrl}${widget.list[widget.indexVideo]["video"]["video"]}",
                        //         fileName: widget.list[widget.indexVideo]["video"]["video"],
                        //     ),
                        //     );
                        //   },
                        //   child: const Icon(
  ...
  void goToUserProfile() {
    if (widget.videoData['user_data'] != null) {
      ...
      // Get.off(() =>
      Get.to(() =>
          UserProfileScreen(userData: widget.videoData['user_data']))!
          .whenComplete(() => Get.back());
    }
  }
  ...
  updateFollowStatus() {
    if (widget.videoData["followBack"] == "1") {
      ...
      widget.videoData["followBack"] = "0";
    } else {
      Get.find<FollowController>().followUnfollowUpdateList(
          followId: widget.videoData["user_data"]["_id"], status: "true");
      widget.videoData["followBack"] = "1";
    }
  }
