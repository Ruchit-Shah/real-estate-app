...
typedef OnRemoveWishlistCallback = void Function(bool showresult);
class GFSearchBar<T> extends StatefulWidget {
  ...
  final OnRemoveWishlistCallback onRemoveWishlistCallback;
...
class MySingleChoiceSearchState<T> extends State<GFSearchBar<T?>> {
  ...
  Widget build(BuildContext context) {
    ...
    searchBox = Container(
      ...
      child: TextField(
        ...
        style: TextStyle(fontSize: 16, color: AppColor.grey[600]),
  ...
  void onSearchListItemSelected(T? item) {
    ...
    if (widget.onItemSelected != null) {
      ...
      showresult1=true;
      widget.onRemoveWishlistCallback(showresult1);
    }
  }
  ...
  void onTextFieldFocus() {
    ...
    final width = searchBoxRenderBox.size.width/1.5;
        ...
        builder: (context) => Positioned(
          ...
          child: CompositedTransformFollower(
            ...
            child: Card(
              ...
              color: AppColor.black.withOpacity(.45),
              elevation: 5,
              ...
              child: _searchList.isNotEmpty
                ...
                child: widget.noItemsFoundWidget,
                  ...
                  : Container(
                color: AppColor.transparent,
                child: Text(no_items,style: TextStyle(
